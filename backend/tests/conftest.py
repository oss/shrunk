...
@pytest.fixture()
def db(app: Flask) -> Generator[ShrunkClient, None, None]:  # pylint: disable=redefined-outer-name
...
@pytest.fixture()
def client(app: Flask) -> Generator[Client, None, None]:  # pylint: disable=redefined-outer-name
