...
#     ]
# )
# def test_create_delete_ticket(client: Client, reporter: str, reason: str, entity: str, comment: str):
...
#         resp = client.delete(f"/api/v1/ticket/{str(base64.b32encode(bytes(ticket_id, 'utf8')), 'utf8')}")
#         assert resp.status_code == 204, "Failed to delete ticket"

# @pytest.mark.parametrize(
#     ("tickets"),
#     [
#         [{"reporter": "DEV_USER", "reason": "power_user", "entity": "DEV_USER", "comment": "I need power user access"}],
#         [{"reporter": "DEV_USER", "reason": "power_user", "entity": "DEV_USER", "comment": "I need power user access"}, {"reporter": "DEV_USER", "reason": "whitelisted", "entity": "ejw135", "comment": "I need to whitelist this person"}],
#         [{"reporter": "DEV_USER", "reason": "power_user", "entity": "DEV_USER", "comment": "I need power user access"}, {"reporter": "DEV_USER", "reason": "whitelisted", "entity": "ejw135", "comment": "I need to whitelist this person"}, {"reporter": "DEV_USER", "reason": "other", "entity": None, "comment": "I have an issue"}],
#     ]
# )
