...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed top-[50%] left-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 rounded-md border border-border bg-muted p-6 text-foreground shadow-none data-[state=closed]:animate-out data-[state=closed]:zoom-out-0 data-[state=open]:animate-in data-[state=open]:zoom-in-0',
        className,
      )}
      {...props}
    >
