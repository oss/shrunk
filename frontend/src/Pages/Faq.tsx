...
const accessRows: AccessRow[] = [
  { action: 'Visit Link', access: 4 },
  { action: 'View Link Info', access: 3 },
  { action: 'View Link Stats', access: 3 },
  { action: 'View Link Visits', access: 3 },
  { action: 'View Alias Stats', access: 3 },
  { action: 'View Alias Visits', access: 3 },
  { action: 'Create Alias', access: 2 },
  { action: 'Modify Link', access: 2 },
  { action: 'Modify Link Permissions', access: 2 },
  { action: 'Modify Link Owner', access: 1 },
  { action: 'Delete Alias', access: 1 },
  { action: 'Delete Link', access: 1 },
  { action: 'Reset Visit Count', access: 1 },
];
...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        To grant access to an undergraduate user, send an email to&nbsp;
        <a href="mailto:oss@oit.rutgers.edu">oss@oit.rutgers.edu</a> with the
        user&rsquo;s NetID and the reason the user needs access to Go.
        Undergraduate users should only use Go for purposes related to their
