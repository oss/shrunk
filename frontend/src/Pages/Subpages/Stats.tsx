...
import VisitsChart from '@/Components/Link/VisitsChart';
import GeoipChart from '@/Components/Link/WorldChart';
import ShrunkPieChart from '@/Components/PieChart';
...
export function Stats(props: Props): React.ReactElement {
  ...
  const downloadCanvasQRCode = () => {
    ...
    if (canvas) {
      ...
      downloadUrl(`${linkInfo?.alias}.png`, url);
    }
  };
