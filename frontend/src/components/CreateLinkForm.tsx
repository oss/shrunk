 ...
 */
 const AliasLabel: React.FC = (_props) => {
  ...
  add a description for each alias you generate. Please note 
  you may custom your aliases as a power user. Check the FAQ 
  for more info.`;
  return (
...
export class CreateLinkForm extends React.Component<Props, State> {
  ...
  render(): React.ReactNode {
    ...
    const aliasPrefix = (<p style={{color: '#808080'}}>go.rutgers.edu/</p>)
    return (
                ...
                {fields.map((field, index) => (
                  ...
                  >
                    {!mayUseCustomAliases ? (
                      ...
                      >
                        <Input addonBefore="go.rutgers.edu/" placeholder="alias" />
                      </Form.Item>
                    )}
