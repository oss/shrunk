...
export default function MultiLinkSelectPopup({
  ...
  return (
    <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }}>
      <TooltipProvider>
        <section className="fixed bottom-6 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-md border border-border bg-popover px-4 py-3 text-popover-foreground shadow-lg">
          <div>
            <Tooltip>
