...
>(({ className, children, ...props }, ref) => {
  ...
  React.useEffect(() => {
    ...
    // Radix keeps aria-controls on closed Select triggers even though the
    // referenced listbox is intentionally unmounted. Keep the relationship
    // while open, but avoid leaving a broken IDREF for accessibility tools.
