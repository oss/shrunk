      ...
      <Collapse bordered={false}>
        ...
        >
          <p style={{ paddingLeft: 24 }}>
            ...
            their NetID and password. Undergraduate student workers can be
            granted access to Go by a faculty or staff member.
          </p>
        </Panel>
        <Panel
        ...
        >
          <p style={{ paddingLeft: 24 }}>
            ...
            there you can give your link a name in the title field, then you can
            paste your long link in the <b>Long URL</b> field. After that you
            can optionally set a time for your link to expire. Then you have
            option to set up a description for your link. Additionaly, with
            Power user access you can add a custom ending to your URL.
          </p>
        </Panel>
        ...
        >
          <p style={{ paddingLeft: 24 }}>
            ...
            group of users to view each other&rsquo;s links. For example, users
            working together on a project may want to be able to see each
            other&rsquo;s links.
          </p>
        </Panel>
        <Panel
        ...
        >
          <p style={{ paddingLeft: 24 }}>
            ...
            you cannot edit it. You can request edit access by hitting the mail
            icon next to the link which will send a request to the owner of the
            link.
          </p>
        </Panel>
        <Panel
        ...
        >
          <p style={{ paddingLeft: 24 }}>
            ...
            This downloads onto your computer a .csv file of link statistics for
            that specific link. The .csv file includes which alias was used to
            access the link, visitor ID, referrer, approximate location of the
            user, and time accessed.
          </p>
        </Panel>
        <Panel
