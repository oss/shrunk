...
const US_MAP_URL = 'https://code.highcharts.com/mapdata/countries/us/us-all.geo.json';
...
const WORLD_MAP_URL = 'https://code.highcharts.com/mapdata/custom/world.geo.json';
