...
// import '@highcharts/map-collection/countries/us/us-all';
...
$.getJSON($('#endpoints').attr('data-visits-daily-endpoint') as string,
...
$.getJSON($('#endpoints').attr('data-referer-endpoint') as string,
          (json) => {
...
$.getJSON($('#endpoints').attr('data-useragent-endpoint') as string,
          (json) => {
